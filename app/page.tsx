...
>
  Reparación de PC, notebooks, pymes empresariales y soluciones informáticas.{" "}
  <span className="block mt-2 font-semibold text-cyan-400 bg-cyan-500/10 px-3 py-1 rounded-lg inline-block text-sm md:text-base animate-pulse">
     ¿Tu equipo no enciende o está lento? Diagnóstico rápido en Venado Tuerto.
        ...
        <motion.p
          ...
          className="mx-auto mb-10 max-w-2xl text-pretty text-lg text-slate-400 md:text-xl"
        >
          Reparacion de PC, notebooks, cyanes empresariales y soluciones
...
const reviewsBase = [
  ...
  },
  {
    ...
    role: "Abono Mensual",
    text: "Tenemos el abono de mantenimiento para nuestras oficinas. Ante cualquier problema de cyan responden al instante. Un alivio técnico.",
    stars: 5,
  },
];
