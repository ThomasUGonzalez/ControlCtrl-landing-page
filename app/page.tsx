            ...
            <div className="rounded-2xl border border-slate-700 bg-[#1e293b] p-6 shadow-2xl md:p-8">
              <div className="mb-6 flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-ambar-500 to-ambar-600">
              ...
              <ul className="mb-8 space-y-3">
                {service.details.map((detail, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <ChevronRight className="mt-0.5 h-5 w-5 shrink-0 text-ambar-400" />
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-ambar-500 to-ambar-600 py-3 font-semibold text-[#0f172a] transition-all hover:from-orange-500 hover:to-orange-600"
              >
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0f172a]/70 px-6 py-4 backdrop-blur-xl">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-ambar-400 to-ambar-600">
                <Monitor className="h-5 w-5 text-[#0f172a]" />
              </div>
              <span className="text-lg font-bold text-white">
                Control<span className="text-ambar-400">SI</span>
              </span>
            </div>
            ...
            <div className="hidden items-center gap-8 md:flex">
              <a
                href="#servicios"
                className="text-sm text-slate-300 transition-colors hover:text-ambar-400"
              >
                Servicios
              </a>
              <a
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="hidden rounded-xl bg-gradient-to-r from-ambar-500 to-ambar-600 px-5 py-2.5 text-sm font-semibold text-[#0f172a] transition-all hover:from-orange-500 hover:to-orange-600 hover:shadow-lg hover:shadow-orange-500/25 md:block"
            >
              Soporte Urgente
            </motion.a>
            ...
            {isOpen && (
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-xl bg-gradient-to-r from-ambar-500 to-ambar-600 px-5 py-2.5 text-center text-sm font-semibold text-[#0f172a] transition-all hover:from-orange-500 hover:to-orange-600"
                >
                  Soporte Urgente
                </a>
              </motion.div>
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 pt-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-ambar-500/20 blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-ambar-600/10 blur-3xl" />
      </div>
...
>
  ...
  <span className="block mt-2 font-semibold text-ambar-400 bg-ambar-500/10 px-3 py-1 rounded-lg inline-block text-sm md:text-base animate-pulse">
     ¿Tu equipo no enciende o está lento? Diagnóstico rápido en Venado Tuerto.
        ...
        >
          ...
          <span className="bg-gradient-to-r from-ambar-400 to-ambar-300 bg-clip-text text-transparent">
            {" "}
            mejores manos
          </span>
        </motion.h1>
        ...
        >
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="group flex items-center gap-2 rounded-xl bg-gradient-to-r from-ambar-500 to-ambar-600 px-8 py-4 text-lg font-semibold text-[#0f172a] shadow-lg shadow-ambar-500/25 transition-all hover:from-orange-500 hover:to-orange-600 hover:shadow-orange-500/25"
          >
            <MessageCircle className="h-5 w-5" />
            Contactanos Ahora
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="rounded-xl border border-slate-600 px-8 py-4 text-lg font-semibold text-white transition-all hover:border-ambar-500 hover:bg-ambar-500/10"
          >
            Ver Servicios
          </motion.a>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-3xl font-bold text-ambar-400 md:text-4xl">
              {stat.value}
              </div>
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {brands.map((brand, index) => (
            ...
            >
              <span className="text-xl font-bold tracking-wider text-slate-600 opacity-50 transition-all duration-300 group-hover:text-ambar-400 group-hover:opacity-100 md:text-2xl">
                {brand.logo}
              </span>
            </motion.div>
          ))}
    ...
    <section id="servicios" className="px-4 py-24">
      <div className="mx-auto max-w-7xl">
        <AnimatedSection className="mb-16 text-center">
          <span className="mb-4 inline-block rounded-full border border-ambar-500/30 bg-ambar-500/10 px-4 py-2 text-sm font-medium text-ambar-400">
            Nuestros Servicios
          </span>
          <h2 className="mb-4 text-balance text-3xl font-bold text-white md:text-5xl">
            Soluciones informaticas
            <span className="text-ambar-400"> integrales</span>
          </h2>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-ambar-500/20 to-ambar-600/20 transition-all group-hover:from-ambar-500 group-hover:to-ambar-600">
                <service.icon className="h-7 w-7 text-ambar-400 transition-colors group-hover:text-[#0f172a]" />
              </div>
              ...
              <span className="text-sm font-medium text-ambar-400 transition-colors group-hover:text-ambar-300">
                Ver detalles
              </span>
            </motion.div>
          ))}
    ...
    <section id="ubicacion" className="px-4 py-24">
      <div className="mx-auto max-w-7xl">
        <AnimatedSection className="mb-16 text-center">
          ...
          <h2 className="mb-4 text-balance text-3xl font-bold text-white md:text-5xl">
            Visitanos en{" "}
            <span className="text-ambar-400">Venado Tuerto</span>
          </h2>
          <p className="mx-auto max-w-2xl text-pretty text-slate-400">
            ...
            <div className="rounded-2xl border border-slate-700 bg-[#1e293b]/50 p-8">
              ...
              <div className="mb-8 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-ambar-500/20">
                    <MapPin className="h-5 w-5 text-ambar-400" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-ambar-500/20">
                    <Phone className="h-5 w-5 text-ambar-400" />
                  </div>
                  <div>
          ...
          <div className="grid items-center lg:grid-cols-2">
            <AnimatedSection className="p-8 md:p-12 lg:p-16">
              ...
              <h2 className="mb-6 text-balance text-3xl font-bold text-white md:text-4xl">
                ...
                <span className="text-ambar-400">{CONFIG.ciudad} y zona</span>
              </h2>
              ...
              <div className="mb-8 space-y-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-ambar-500/20">
                      <feature.icon className="h-5 w-5 text-ambar-400" />
                    </div>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-ambar-500 to-ambar-600 px-6 py-3 font-semibold text-[#0f172a] transition-all hover:from-orange-500 hover:to-orange-600"
              >
                <MessageCircle className="h-5 w-5" />
            ...
            <div className="relative hidden h-full min-h-[400px] lg:block">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="mb-4 text-8xl font-bold text-ambar-500/20">
    ...
    <section id="reseñas" className="px-4 py-24 border-t border-slate-800 bg-[#0f172a]/30">
      <div className="mx-auto max-w-7xl">
        <AnimatedSection className="mb-16 text-center">
          ...
          <h2 className="mb-4 text-balance text-3xl font-bold text-white md:text-5xl">
            La confianza de nuestra <span className="text-ambar-400">comunidad</span>
          </h2>
          <p className="mx-auto max-w-2xl text-pretty text-slate-400">
          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              <div className="border-t border-slate-700/50 pt-4">
                ...
                <p className="text-xs text-ambar-400">{review.role}</p>
              </div>
            </motion.div>
          ))}
        </div>
    ...
    <section id="faq" className="px-4 py-24">
      <div className="mx-auto max-w-3xl">
        <AnimatedSection className="mb-16 text-center">
          ...
          <h2 className="mb-4 text-balance text-3xl font-bold text-white md:text-5xl">
            Dudas <span className="text-ambar-400">comunes</span>
          </h2>
          <p className="mx-auto max-w-2xl text-pretty text-slate-400">
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <ChevronDown className="h-5 w-5 text-ambar-400" />
                  </motion.div>
                </button>
                <AnimatePresence>
                  {openIndex === index && (
      ...
      <div className="flex gap-8">
        ...
        >
          {[...clients, ...clients].map((client, index) => (
            ...
            >
              <Building2 className="h-5 w-5 text-ambar-400" />
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li>
                <a href="#servicios" className="transition-colors hover:text-ambar-400">
                  Soporte de Software
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-center gap-2" suppressHydrationWarning>
                <Phone className="h-4 w-4 text-ambar-400" />
                {CONFIG.telefonoFormateado}
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-ambar-400" />
                {CONFIG.email}
              </li>
              <li className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-ambar-400" />
                {CONFIG.direccion}
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="text-ambar-400">Urgencias: 24hs por WhatsApp</li>
            </ul>
            <motion.a
              href={WHATSAPP_URL}
              target="_blank"
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="mt-4 inline-flex items-center gap-2 rounded-lg bg-ambar-500/20 px-4 py-2 text-sm font-medium text-ambar-400 transition-colors hover:bg-ambar-500/30"
            >
...
function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-ambar-500 text-white shadow-lg shadow-ambar-500/30 transition-colors hover:bg-orange-500 hover:shadow-orange-500/30"
    >
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
